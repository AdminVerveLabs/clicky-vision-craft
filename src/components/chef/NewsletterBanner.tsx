...
const NewsletterBanner = () => (
  <section className="bg-gradient-to-br from-purple to-purple-dark py-20 px-6 text-center relative overflow-hidden">
    ...
    <div className="max-w-[600px] mx-auto relative">
      ...
      <h2 className="font-serif text-4xl font-extrabold text-white mt-4 mb-3 leading-tight">
      ...
      <div className="flex gap-3 max-w-[460px] mx-auto">
        <input
          type="email"
