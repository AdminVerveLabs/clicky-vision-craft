    ...
    <div>
      <section className="pt-[100px] md:pt-[120px] pb-16 md:pb-20 bg-white">
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="mb-2">
            <span onClick={() => go("/teams")} className="font-sans text-[13px] text-gray cursor-pointer">Teams & Corporate</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
            <div>
              ...
              <h1 className="font-serif text-[32px] md:text-5xl font-extrabold text-dark leading-[1.1] mt-5 mb-5">
                Reward your team with an <span className="text-purple italic">experience</span>
              </h1>
              <p className="font-sans text-[16px] md:text-[17px] text-gray leading-[1.7] mb-8">
                Forget generic gift baskets. Give your team something they'll actually remember — a hands-on cooking
                experience with Chef Joey. Available in bulk with corporate branding options.
              </p>
              <div className="flex gap-4 flex-wrap">
                <CTAButton variant="green" size="lg">Order Gift Cards</CTAButton>
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12">
            <div>
              ...
              {[
                { icon: "🎫", label: "Options", value: "Any team experience, any amount", color: "purple" as const },
                { icon: "📦", label: "Bulk Orders", value: "Discounted rates for 10+ gift cards", color: "sage" as const },
                { icon: "🏢", label: "Branding", value: "Add your company logo and custom message", color: "purple" as const },
                { icon: "📧", label: "Delivery", value: "Digital or premium printed cards", color: "sage" as const },
                { icon: "📅", label: "Validity", value: "Never expires — use anytime", color: "purple" as const },
                { icon: "✅", label: "Includes", value: "Full team experience — everything covered", color: "sage" as const },
              ].map((item, i) => (
            ...
            <div>
              <h2 className="font-serif text-[24px] md:text-[32px] font-extrabold text-dark mb-6 md:mb-8">Popular Uses</h2>
              <div className="bg-white rounded-2xl p-6 md:p-8 border border-border">
                {["Employee appreciation & rewards", "Client thank-you gifts", "Holiday & end-of-year rewards", "Milestone celebrations", "New hire welcome gifts"].map((item, i) => (
      ...
      <section className="py-16 md:py-20 px-6 bg-gradient-to-br from-purple to-purple-dark text-center">
        <div className="max-w-[600px] mx-auto">
          <h2 className="font-serif text-3xl md:text-4xl font-extrabold text-white mb-4">Give your team something memorable</h2>
          <p className="font-sans text-sm md:text-base text-white/70 mb-8">Bulk pricing available. Custom branding included. Your team will thank you.</p>
          <CTAButton variant="green" size="lg">Order Gift Cards</CTAButton>
        </div>
      </section>
...
export default TeamGiftCardsPage;
