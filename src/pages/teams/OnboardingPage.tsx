    ...
    <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12">
            <div>
              ...
              {[
                ...
                { icon: "👥", label: "Group Size", value: "5 – 25 people (new hires + buddies)", color: "sage" as const },
                { icon: "🎯", label: "Focus", value: "Connection, culture, and collaboration", color: "purple" as const },
                { icon: "📍", label: "Location", value: "Our Kitchen · Your Office · Virtual", color: "sage" as const },
                { icon: "🔄", label: "Frequency", value: "Monthly, quarterly, or per cohort", color: "purple" as const },
            ...
            <div>
              <h2 className="font-serif text-[24px] md:text-[32px] font-extrabold text-dark mb-6 md:mb-8">The Impact</h2>
      ...
      <section className="py-16 md:py-20 px-6 bg-gradient-to-br from-purple to-purple-dark text-center">
        <div className="max-w-[600px] mx-auto">
          <h2 className="font-serif text-3xl md:text-4xl font-extrabold text-white mb-4">Make onboarding unforgettable</h2>
          <p className="font-sans text-sm md:text-base text-white/70 mb-8">Let's design an onboarding experience that sets the tone for your company culture.</p>
